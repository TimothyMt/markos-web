> ⚠️ **ĐÃ LƯU TRỮ (2026-07-08).** Bản này đã lỗi thời (còn liệt S-10/11/12 campaign-hub mà Vision A
> đã CẤT; nhiều slice ⬜ thực ra đã làm). Nguồn thật hiện tại = **`docs/web/roadmap.md`** (roadmap v2
> theo 4 tầng). Giữ file này chỉ để tra vết slice S-xx cũ.
