...
| `stage` | enum `launch\|growth\|scale` | `brain.select()` (K2/K3) | **CHƯA AI** — Spine không hỏi; `stage` trong code là stage-phễu (khái niệm khác) | — | ❌ cần **A1** (hỏi 1 câu / suy từ baseline) |
